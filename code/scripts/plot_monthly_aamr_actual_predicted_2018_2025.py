...
def build_monthly_aamr_actual_predicted_plot_2018_2025() -> None:
    ...
    fig.suptitle(
        "Observed and predicted monthly age-adjusted mortality rates, 2018-2025",
        y=0.985,
        fontsize=14,
        fontweight="bold",
    )
    ...
    fig.savefig(FIGURE_DIR / "monthly_aamr_actual_2018_2025_predicted_from_2018.png", dpi=300)
    fig.savefig(FIGURE_DIR / "monthly_aamr_actual_2018_2025_predicted_from_2018.pdf")
    plt.close(fig)


if __name__ == "__main__":
    build_monthly_aamr_actual_predicted_plot_2018_2025()
